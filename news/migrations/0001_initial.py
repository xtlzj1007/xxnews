# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2018-11-03 12:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='default.png', max_length=30, upload_to='image/%Y/%m', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clicked', models.IntegerField(verbose_name='点击量')),
            ],
            options={
                'verbose_name': '文章内容',
                'verbose_name_plural': '文章内容',
        ...
        migrations.AddField(
            model_name='content',
            name='type_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='context', to='news.Type', verbose_name='新闻类型'),
        ),
        migrations.AddField(
            model_name='content',
            name='user_id',
        ...
        migrations.AddField(
            model_name='comment',
            name='news_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='news.Content', verbose_name='新闻'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user_id',
